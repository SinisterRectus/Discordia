return {
	...
	THREAD_START                    = "/channels/%s/messages/%s/threads",
	THREAD_START_WITHOUT_MESSAGE    = "/channels/%s/threads",
	THREAD_MEMBER                   = "/channels/%s/thread-members/%s",
	THREAD_MEMBER_ME                = "/channels/%s/thread-members/@me",
	THREAD_MEMBERS                  = "/channels/%s/thread-members",
	THREAD_ARCHIVED                 = "/channels/%s/threads/archived/public",
	THREAD_ARCHIVED_PRIVATE         = "/channels/%s/threads/archived/private",
	THREAD_JOINED_ARCHIVED_PRIVATE  = "/channels/%s/users/@me/threads/archived/private",
}
