...
The Snowflake ID that can be used to identify the object. This is guaranteed to
...
The Unix time in seconds at which this object was created by Discord. Additional
decimal points may be present, though only the first 3 (milliseconds) should be
considered accurate.

Equivalent to `Date.parseSnowflake($.id)`.
]]
