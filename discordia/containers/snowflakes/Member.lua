...
method('setMute', setMute, '[boolean]', "Mutes or unmutes the member guild-wide (default: false).", 'HTTP')
method('setDeaf', setDeaf, '[boolean]', "Deafens or undeafens the member guild-wide (default: false).", 'HTTP')
method('getMembership', getMembership, '[guild]', "Shortcut for `member.user:getMembership`", 'Local or HTTP')
method('sendMessage', sendMessage, 'content', "Shortcut for `member.user:sendMessage`", 'HTTP')
method('ban', ban, '[guild][, days]', "Shortcut for `member.user:ban`. The member's guild is used if none is provided.", 'HTTP')
method('unban', unban, '[guild]', "Shortcut for `member.user:unban`. The member's guild is used if none is provided.", 'HTTP')
method('kick', kick, '[guild]', "Shortcut for `member.user:kick`. The member's guild is used if none is provided.", 'HTTP')
method('addRole', addRole, 'role', "Adds a role to the member.", 'HTTP')
method('addRoles', addRoles, 'roles[, ...]', "Adds a role or roles to the member.", 'HTTP')
method('removeRole', removeRole, 'role', "Removes a role from the member.", 'HTTP')
method('removeRoles', removeRoles, 'roles[, ...]', "Removes a role or roles from the member.", 'HTTP')
