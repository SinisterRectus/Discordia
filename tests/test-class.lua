...
assertError(function() return foo.undefined end, 'undefined field')
assertError(function() return bar.undefined end, 'undefined field')
assertError(function() return baz.undefined end, 'undefined field')

assertError(function() foo.getFoo = 'test' end, 'cannot override field')
assertError(function() bar.getFoo = 'test' end, 'cannot override field')
assertError(function() bar.getBar = 'test' end, 'cannot override field')
assertError(function() baz.getFoo = 'test' end, 'cannot override field')
assertError(function() baz.getBar = 'test' end, 'cannot override field')
assertError(function() baz.getBaz = 'test' end, 'cannot override field')

assertError(function() foo._foo = 'test' end, 'private field')
assertError(function() bar._foo = 'test' end, 'private field')
assertError(function() bar._bar = 'test' end, 'private field')
assertError(function() baz._foo = 'test' end, 'private field')
assertError(function() baz._bar = 'test' end, 'private field')
assertError(function() baz._baz = 'test' end, 'private field')

assertError(function() foo:testFoo() end, 'cannot declare field outside of __init')
assertError(function() bar:testFoo() end, 'cannot declare field outside of __init')
assertError(function() bar:testBar() end, 'cannot declare field outside of __init')
assertError(function() baz:testFoo() end, 'cannot declare field outside of __init')
assertError(function() baz:testBar() end, 'cannot declare field outside of __init')
assertError(function() baz:testBaz() end, 'cannot declare field outside of __init')
