...
assertError(function() return Date(-1) end, 'input must be a positive integer')
assertError(function() return Date(1.1) end, 'input must be a positive integer')
assertError(function() return Date(1, 1.1) end, 'input must be a positive integer')
assertError(function() return Date(1, -1) end, 'input must be a positive integer')
