...
assertError(function() return Color() + {} end, 'cannot perform operation')
assertError(function() return Color() - {} end, 'cannot perform operation')
assertError(function() return Color() % {} end, 'attempt to perform arithmetic on a table value')
assertError(function() return Color() * {} end, 'cannot perform operation')
assertError(function() return Color() / {} end, 'cannot perform operation')
...
assertError(function() return Color() + 1 end, 'cannot perform operation')
assertError(function() return Color() - 1 end, 'cannot perform operation')
assertError(function() return Color() % 1 end, 'attempt to perform arithmetic on a table value')
